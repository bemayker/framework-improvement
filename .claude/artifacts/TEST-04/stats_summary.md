...
Generated 2026-07-28 09:13 UTC. Token metrics: available. Skill load: read.
...
| 11 | Phase D, E2E Test Generation | 1m41s | 20 | 23 | 1.21 | 3 | 262 | 102.6K | 109.9K | 0 | 0.99 | claude-sonnet-5 | 4/2/13 | 2.00/1.00/1.00 |  |
| 12 | Phase E, Self-Review | 2m31s | 18 | 44 | 2.75 | 9 | 8.6K | 137.5K | 406.7K | 0 | 0.911 | claude-sonnet-5 | 5/1/9 | 3.60/1.00/2.56 | ctx>threshold |
...
| **run total** |  | 21m14s | 85 | 124 | 1.53 | 9 | 27.7K |  | 450.5K |  | 0.973 | claude-sonnet-5 | 11/10/56 | 3.27/1.10/1.29 |  |
...
| agent-a7ffb77f519cb97b9 | build-feature | 12 | 10 | 23 | 2.56 | 0/1/8 | n/a/1.00/2.75 | 1.5K | 118.0K | 131.0K | 0.903 | claude-sonnet-5 |  |
...
| agent-ae176ded75d47519b | build-feature | 11 (+2 outside) | 7 | 20 | 3.33 | 6/0/0 | 3.33/n/a/n/a | 38 | 80.3K | 95.4K | 0.83 | claude-sonnet-5 |  |

**9 dispatch(es):** median ctx max 109.0K, peak 131.0K, 0 above the 200,000-token threshold. Distribution: 87.2K, 95.4K, 96.5K, 102.2K, 109.0K, 110.1K, 114.2K, 128.2K, 131.0K.

**All runs:** 2 run(s), wall 36m54s (sum of per-run walls, idle time between runs excluded), 277 turns, 402 tool calls, 169.5K output tokens, cache hit 0.976.

Turn classes across every bucket, read / edit / exec: 26/22/189 turns, 3.04/1.05/1.35 tools per turn. The **read** figure is the one a batching mandate can be graded on; edits batch weakly and an exec turn is serial by construction.

167 turn(s) fell outside every recorded step window (included in the all-runs totals; read/edit/exec 12/9/116).
